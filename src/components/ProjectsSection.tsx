          ...
          {projects.map((project, index) => (
            <MotionWrapper key={project.title} delay={index * 0.2}>
              <GlassCard className="group overflow-hidden dark:border-blue-500/10 h-full flex flex-col">
                <CardHeader className="bg-gradient-to-r from-blue-500/5 to--500/5">
                ...
                <CardFooter className="flex justify-center md:justify-start items-center border-t border-border/30 bg-gradient-to-r from-blue-500/5 to--500/5">
                  <motion.a
                    href={project.github}
                    target="_blank"
